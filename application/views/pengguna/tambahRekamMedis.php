      ...
      <form method="post" action="<?= base_url('pengguna/tambahRekamMedis'); ?>">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="nomorktp" placeholder="NOMOR KTP" name="nomorktp" value="<?= set_value('nomorktp') ?>">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            <label>Alamat</label>
            <input type="text" style="text-transform: uppercase;" class="form-control" name="alamat" placeholder="ALAMAT" id="inputAddress" value="<?= set_value('alamat') ?>">

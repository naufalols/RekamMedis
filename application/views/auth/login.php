            ...
            <div class="col-lg">
              <div class="p-5">
                <div class="text-center">
                  <h1 class="h4 text-gray-900 mb-4">Selamat Datang di Rekam Medis Kolbu!</h1>
                </div>
                <?= $this->session->flashdata('pesan'); ?>
                <form method="post" action="<?= base_url('auth'); ?>" class="user">
                  <div class="form-group">
                    <input type="text" class="form-control form-control-user" id="surel"  placeholder="Masukkan Email Anda" name="surel" value="<?= set_value('surel')?>">
                     <?= form_error('surel', '<small class="text-danger pl-3">', '</small>'); ?>
                  </div>
                  <div class="form-group">
